...
fn get_after_install(exe: &str) -> String {
    ...
    // https://github.com/mostafarezaei/rima/commit/f4bdfb6936ae4804fc8ab1cf560db192622ad01a
...
copy /Y \"{tmp_path}\\Uninstall {app_name}.lnk\" \"{start_menu}\\\"
    ...
    // Note: without if exist, the bat may exit in advance on some Windows7 https://github.com/mostafarezaei/rima/issues/895
    let dels = format!(
        "
